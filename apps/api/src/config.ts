...
const schema = z.object({
	...
	REFERRAL_PUBLIC_URL: z.string().url().default("https://oynk.io"),
	...
	STELLAR_PUBLIC_RPC_URL: z.string().url().optional(),
	OYNK_VAULT_TESTNET: z.string().default(""),
	OYNK_POOL_TESTNET: z.string().default(""),
	OYNK_ORCHESTRATOR_TESTNET: z.string().default(""),
	OYNK_PROVIDER_REGISTRY_TESTNET: z.string().default(""),
	OYNK_VAULT_PUBLIC: z.string().default(""),
	OYNK_POOL_PUBLIC: z.string().default(""),
	OYNK_ORCHESTRATOR_PUBLIC: z.string().default(""),
	OYNK_PROVIDER_REGISTRY_PUBLIC: z.string().default(""),
	OYNK_RAMP_PROVIDER_TESTNET: z.string().default(""),
	OYNK_RAMP_PROVIDER_PUBLIC: z.string().default(""),
	OYNK_RAMP_SIGNER_SECRET_TESTNET: z.string().default(""),
	OYNK_RAMP_SIGNER_SECRET_PUBLIC: z.string().default(""),
	RAMP_EXECUTION_INTERVAL_MS: z.coerce.number().int().min(1000).max(300000).default(5000),
