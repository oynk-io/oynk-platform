...
description: "Stellar-specific integration architecture for Oynk's wallet access, Anchor on/off-ramp, Blend yield, and Soroban coordination and settlement flow."
icon: "network"
mode: "wide"
---
...
<Warning>
  **Implementation boundary:** The repository currently implements identity, organization access, a business-compliance draft flow, BSC and Solana indexing, PostgreSQL persistence, synchronization controls, aggregate activity APIs, and web interfaces. A separate [Soroban settlement-contract MVP is deployed on Stellar mainnet](https://stellar.expert/explorer/public/contract/CDTDCQ2Y6OASQVJGOFBA2EHP3AV7N6FFULJNEFGMORLYMNHECX7OO2W6). This repository does not contain that contract's source, artifact, bindings, submitter, or event indexer, nor complete smart accounts, payment orchestration, quote routing, provider assignment, or fiat payout connectors. Target-architecture sections describe the hardening and integration still required.
</Warning>
...
- A Soroban MVP is deployed at `CDTDCQ2Y6OASQVJGOFBA2EHP3AV7N6FFULJNEFGMORLYMNHECX7OO2W6`, but its Rust source, complete WASM artifact, generated bindings, deployment manifest, and independent security review are not present here.
