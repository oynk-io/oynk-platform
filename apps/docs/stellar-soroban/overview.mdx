...
<Warning>
  A separate Oynk settlement-contract MVP is [deployed on Stellar mainnet](https://stellar.expert/explorer/public/contract/CDTDCQ2Y6OASQVJGOFBA2EHP3AV7N6FFULJNEFGMORLYMNHECX7OO2W6). Its current live WASM matches the public source artifact documented through the [`settlement-aggregator-protocol`](https://github.com/oynk-io/settlement-aggregator-protocol) submodule. Source verification does not constitute an independent security audit or complete the application integration. Generated application bindings, a submitter, and an event indexer remain unimplemented here.
</Warning>

## Public contract work

The contract workspace is maintained by [Emmanuel Ekoja (`emmanuelekoja`)](https://github.com/emmanuelekoja). Source commit [`60489c3`](https://github.com/oynk-io/settlement-aggregator-protocol/commit/60489c36f9e69aeea54e4075948e5b3e2083d440) builds with the locked toolchain to WASM SHA-256 `d16b5f8a2b9971e2ea45bf0737731ed6348bd83b7c30fde275589f69ea132bc9`. Five SDK invariant tests and [twelve WASM integration tests](https://github.com/oynk-io/settlement-aggregator-protocol/commit/9bb2a0e1d60e4b9ac4fd5cf53e19ad564903a16d) pass. The WASM was [uploaded on mainnet](https://stellar.expert/explorer/public/tx/a59c25cd5c913938e8d759a7055ae4dd3b3e560b0fc650450bb57401540d8737), the existing contract was [upgraded](https://stellar.expert/explorer/public/tx/cc80ceb25ca42487a486aa297c8f497637b1a246395303d88f1a24f7f42cf1a4), and its fetched live bytecode matched the published artifact. Machine-readable evidence is published in [`deployments/mainnet.json`](https://github.com/oynk-io/settlement-aggregator-protocol/blob/main/deployments/mainnet.json).
