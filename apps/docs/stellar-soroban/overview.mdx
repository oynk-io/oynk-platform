...
<Warning>
  A separate Oynk settlement-contract MVP is [deployed on Stellar mainnet](https://stellar.expert/explorer/public/contract/CDTDCQ2Y6OASQVJGOFBA2EHP3AV7N6FFULJNEFGMORLYMNHECX7OO2W6). This repository does not contain its Rust source, WASM artifact, generated bindings, submitter, or event indexer, and the deployment is not presented as an audited production payment system. This section specifies the hardened target architecture and remaining application integration.
</Warning>
