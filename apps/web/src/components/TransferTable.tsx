...
const initialFilters: Filters = { search: "", direction: "ALL", asset: "ALL" };
  ...
  return (
    <div>
      <div className="mb-4 flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
        <div className="grid flex-1 gap-3 sm:grid-cols-2 lg:grid-cols-[minmax(240px,1fr)_repeat(2,150px)]">
      ...
      <div className="hidden overflow-hidden rounded-2xl border border-white/8 bg-white/[.03] md:block">
        <div className="overflow-x-auto">
          <table className="w-full min-w-[1180px] text-left">
            <thead className="border-b border-white/8 bg-white/[.025] text-[11px] uppercase tracking-[.12em] text-slate-500"><tr><th className="px-5 py-4">Time</th><th>Flow</th><th>Chain</th><th>Asset / value</th><th>Tracked wallet</th><th>Counterparty</th><th>Transaction</th><th className="pr-5">Links</th></tr></thead>
            <tbody className="divide-y divide-white/6">
              {filteredRows.map((row) => { const time = formatDateTime(row.timestamp); return (
